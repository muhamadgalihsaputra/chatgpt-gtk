...
if [ -f "$SCRIPT_DIR/assets/chatgpt-gtk.png" ]; then
    cp "$SCRIPT_DIR/assets/chatgpt-gtk.png" "$ICON_BASE/256x256/apps/chatgpt-gtk.png"
fi
...
ln -sf "$APP_DIR/chatgpt-gtk.desktop" "$APP_DIR/io.github.chatgpt_gtk.desktop.desktop"
